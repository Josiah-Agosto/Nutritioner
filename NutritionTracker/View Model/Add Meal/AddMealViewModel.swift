...
final class AddMealViewModel: ObservableObject {
    ...
    private func addNewMeal() {
        ...
        let meal = MealModel(name: mealName, calories: String.multiplyCalories(calories, servingSize), notes: notesText, date: String.getCurrentStringTime(), longDate: String.getCurrentStringDate())
