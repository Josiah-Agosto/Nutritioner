...
class DataManager: DataManagerProtocol {
    ...
    func fetchMeal(from date: String) -> [MealCell] {
        ...
        let result = coreDataHelper.fetchMealCell(MealCell.self, predicate: predicate, limit: nil)
        switch result {
    ...
    func fetchDay(from date: String) -> [Day] {
        ...
        let result = coreDataHelper.fetchDay(Day.self, predicate: predicate, limit: nil)
        switch result {
    ...
    private func addNutrients(_ nutrientsModel: NutrientsModel) -> Meal {
        if let mealEntity = NSEntityDescription.entity(forEntityName: "Meal", in: coreDataHelper.context) {
    ...
    private func addMeal(_ nutrientsModel: NutrientsModel, _ mealModel: MealModel) -> MealCell {
        ...
        if let mealCellEntity = NSEntityDescription.entity(forEntityName: "MealCell", in: coreDataHelper.context) {
    ...
    func addFullMeal(with nutrients: NutrientsModel, _ meal: MealModel, _ day: DayModel) {
        ...
        if let dayEntity = NSEntityDescription.entity(forEntityName: "Day", in: coreDataHelper.context) {
